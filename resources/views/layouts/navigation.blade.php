<nav x-data="{ open: false }" class="bg-[#161616] fixed left-0 right-0 text-white border-b border-gray-700 z-[800]">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('user-products.index')"
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <div class="flex items-center gap-1 mr-6">
                    ...
                    <a href="{{ route('cart.index') }}" class="block py-2 text-sm leading-5 text-white">
                        Cart
                    </a>
                </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                ...
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-gray-100 hover:bg-[#1a1f23] focus:outline-none focus:bg-[#1a1f23] focus:text-gray-100 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link class="bg-[#161616] text-white" :href="route('user-products.index')"
                :active="request()->routeIs('user-products.index')">
                {{ __('Products') }}
            </x-responsive-nav-link>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link class="text-white" :href="route('logout')" onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
                </form>

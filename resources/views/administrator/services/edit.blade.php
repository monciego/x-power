<x-app-layout>
    ...
    <div class="px-2 md:px-40">
        <form action="{{ route('services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="service_start" class="block mb-2 text-sm font-medium text-gray-300">
                    Service Start
                </label>
                <input type="time" name="service_start" id="service_start" value="{{ $service->service_start }}"
                    class="shadow-sm  text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white shadow-sm-light">
                @error('service_start')
                <div class="flex items-center gap-1 mt-1 ml-1">
                    <div>
            ...
            <div class="mb-6">
                <label for="service_end" class="block mb-2 text-sm font-medium text-gray-300">
                    Service End
                </label>
                <input type="time" name="service_end" id="service_end" value="{{ $service->service_end }}"
                    class="shadow-sm  text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 text-white shadow-sm-light">
                @error('service_end')
                <div class="flex items-center gap-1 mt-1 ml-1">
                    <div>
            ...
            <div class="mb-6">
                ...
                <select id="category_service_id" name="category_service_id"
                    ...
                    <option {{ $service->category_service_id == $category->id ? 'selected' : '' }} value="{{
                        $category->id }}" >
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input value="{{ $service->service_price_range }}" type="text" name="service_price_range"
            ...
            <div class="mb-6">
                ...
                <textarea name="service_description" id="service_description" rows="4"
                    class="block p-2.5 w-full text-sm rounded-lg border  bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500">{!! $service->service_description !!}</textarea>
            </div>

            <div class="flex items-start mb-6">
                <div class="flex items-center h-5">
                    <input {{ $service->is_available ==
                    true ? 'checked' : '' }} id="is_available" type="checkbox" name="is_available"
                    class="w-4 h-4 rounded border us:ring-3 bg-gray-700 border-gray-600 focus:ring-blue-600
                    ring-offset-gray-800">
                </div>
                <label for="is_available" class="ml-2 text-sm font-medium text-gray-300">
